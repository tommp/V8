...
bool Mob::update_position(float timedelta, const glm::mat4& view_matrix, const glm::mat4& projection_matrix){
...
bool Mob::update_matrices(const glm::mat4& view_matrix, const glm::mat4& projection_matrix){
	update_model_matrix();
