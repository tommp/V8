...
void main(){    
	...
	vec3 ambient = (lights[instance].color * lights[instance].color_components.x) * albedo_color;

	vec3 diffuse = (lights[instance].color * lights[instance].color_components.y) * diff * albedo_color;
