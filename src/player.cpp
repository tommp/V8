...
bool Player::update_position(GLfloat timedelta, const glm::mat4& view_matrix, const glm::mat4& projection_matrix){
	...
	update_matrices(view_matrix, projection_matrix);
...
bool Player::update_matrices(const glm::mat4& view_matrix, const glm::mat4& projection_matrix){
	update_transform();
	update_model_matrix();
	fill_glm_matrix(model_matrix);
	model_matrix = glm::scale(model_matrix, scale);
	normal_model_matrix = glm::inverseTranspose(glm::mat3(projection_matrix * view_matrix * model_matrix));
