...
private:
	...
	bool update_matrices(const glm::mat4& view_matrix, const glm::mat4& projection_matrix);
public:
	~Player();
	Player();
	Player(Resource_manager& init_manager, const std::string& model_name);
	bool update_position(GLfloat timedelta, const glm::mat4& view_matrix, const glm::mat4& projection_matrix);
